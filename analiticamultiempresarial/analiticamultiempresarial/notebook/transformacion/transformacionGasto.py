...
def total_gastado_por_descripcion(data_frame_gasto):
    ...
    gastos_mayores = data_frame_gasto[data_frame_gasto["monto"] > 0]
...
def promedio_gasto_por_descripcion(data_frame_gasto):
    ...
    gastos_validos= data_frame_gasto[data_frame_gasto["monto"] > 0]
...
def gastos_grandes_por_descripcion(data_frame_gasto):
    ...
    gastos_grandes = data_frame_gasto[data_frame_gasto["monto"] > 100000]
...
# .groupby("descripcion") -> agrupa por descripcion
# .agg() -> permite calcular varios valores a la vez para cada grupo
# dentro de agg() se definen las nuevas columnas que queremos crear:
# .reset_index() -> para convertir el indice de nuevo en una columna normal
# .sort_values() -> para ordenar el resultado por monto_total de mayor a menor
